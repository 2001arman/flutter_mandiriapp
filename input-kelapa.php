...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $query_insert= "INSERT INTO `kelapa_sawit_koperasi` SET `kabupaten_kota`='$kota',`cif`='$cif', `nama_koperasi`='$namaKoperasi', kebun_inti='$kebunInti', luas_lahan = '$luasLahan', jumlah_anggota = '$jumlahAnggota', id_cabang = '3', check_bmri = '$checkBMRI', check_debitur = '$checkDebitur', area = '$area', id_sektor = '1' ";
